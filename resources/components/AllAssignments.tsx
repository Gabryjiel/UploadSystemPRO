...
export const AllAssignments = () => {
  ...
  return (
    <div className='stack'>
      <h1 className='text-2xl sm:text-3xl px-1 pb-2 mt-1 mb-2 border-l-1 border-current select-none'>all assignments</h1>
      <h2 className='sm:text-lg font-light ml-1 mb-5 overflow-hidden overflow-ellipsis box orient-vertical clamp-2'>List of all assignments available to you</h2>
