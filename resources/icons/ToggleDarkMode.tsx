...
import { Icon, TToggle } from './Icon'

export const ToggleDarkMode = (props: TToggle) => {
  const { toggled, ...svgProps } = props

  return (
    <Icon stroke='currentColor' fill='currentColor' strokeWidth='0' viewBox='0 0 24 24' {...svgProps}>
      {toggled ?
